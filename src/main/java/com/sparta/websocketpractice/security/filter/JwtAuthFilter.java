package com.sparta.websocketpractice.security.filter;

import com.sparta.websocketpractice.security.jwt.HeaderTokenExtractor;
import com.sparta.websocketpractice.security.jwt.JwtPreProcessingToken;
...
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(
        ...
        if (tokenPayload == null) {
            System.out.println("또 토큰이 없어서 문제가 생기나?");
